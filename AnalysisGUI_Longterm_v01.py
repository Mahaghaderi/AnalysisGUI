...
class MainWindow(QMainWindow):
    ...
    def plot_chart_patient_report(self):
        ...
        active_values = {
             ...
             'Long-term1': (round(self.mvcd[2], 1) , round(self.mvcp[2], 1) , round(self.AROM[2], 1) , round(self.speed[2], 1) ),
             'Long-term2': (round(self.mvcd[1], 1) , round(self.mvcp[1], 1) , round(self.AROM[1], 1) , round(self.speed[1], 1) ),
        }
