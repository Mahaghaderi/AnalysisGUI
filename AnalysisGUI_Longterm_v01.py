...
class MainWindow(QMainWindow):
    ...
    def plot_chart_patient_report(self):
        ...
        passive_values = {
             ...
             'Long-term1': (round(self.PR_dorsi[2],2), round(self.PR_plantar[2],2), round(self.stiffness_improvement[0],2)),
             'Long-term2': (round(self.PR_dorsi[1],2), round(self.PR_plantar[1],2) ,round(self.stiffness_improvement[1],2)),
        }
        ...
        active_values = {
             ...
             'Long-term1': (round(self.mvcd[2], 2) , round(self.mvcp[2], 2) , round(self.AROM[2], 2) , round(self.speed[2], 2) ),
             'Long-term2': (round(self.mvcd[1], 2) , round(self.mvcp[1], 2) , round(self.AROM[1], 2) , round(self.speed[1], 2) ),
        }
