...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        data_label3 = QLabel("Enter the path of the dataset2 considered as long-term 1:")
        self.dir_input3 = QLineEdit()
        data_label2 = QLabel("Enter the path of the dataset3 considered as long-term 2:")
        ...
        button_names = ["TV 5", "TV 50", "TV 100", "TV 120", "MVC", "VOLUNTARY", "ROM", "RMVC_l2", "RMVC_B", "RMVC_l1"]
        self.buttons = []
        ...
        slider_labelx2 = QLabel("X Long2")
        slider_labely2 = QLabel("Y Long2")
        slider_labelx3 = QLabel("X Long1")
        slider_labely3 = QLabel("Y Long1")
    ...
    def plot_chart_patient_report(self):
        ...
        passive_values = {
             ...
             'Long-term1': (round(self.PR_dorsi[2],1), round(self.PR_plantar[2],1), round(self.stiffness_improvement[0],1)),
             'Long-term2': (round(self.PR_dorsi[1],1), round(self.PR_plantar[1],1) ,round(self.stiffness_improvement[1],1)),
        }
        ...
        active_values = {
             ...
             'Long-term1': (round(self.mvcd[2], 1) , round(self.mvcp[2], 1) , round(self.AROM[1], 1) , round(self.speed[1], 1) ),
             'Long-term2': (round(self.mvcd[1], 1) , round(self.mvcp[1], 1) , round(self.AROM[2], 1) , round(self.speed[2], 1) ),
        }
    ...
    def plot_chart(self):
        ...
        if button_index == 0:
           ...
           # Read the neutral position_tv text file
            ...
            self.stiffness_improvement = [(((torque_sampled.diff().iloc[round(len(torque_sampled.diff())/2):].mean()) - (torque_sampled3.diff().iloc[round(len(torque_sampled3.diff())/2):].mean()))/(torque_sampled.diff().iloc[round(len(torque_sampled.diff())/2):].mean()))*100 , (((torque_sampled.diff().iloc[round(len(torque_sampled.diff())/2):].mean()) - (torque_sampled2.diff().iloc[round(len(torque_sampled2.diff())/2):].mean()))/(torque_sampled.diff().iloc[round(len(torque_sampled.diff())/2):].mean()))*100]
            ...
            ax.bar(position_sampled3, dy_torque_sampled3,alpha=0.3, label='Long1')
            ax.bar(position_sampled2, dy_torque_sampled2,alpha=0.3, label='Long2')
            ...
            ax1.plot(position_smoothed_tv_3 , torque_smoothed_tv_3 , label = 'Long1')
            ax1.plot(position_smoothed_tv_2 , torque_smoothed_tv_2 , label = 'Long2')
           ...
           # Read the neutral position_tv text file
            ...
            line3 = f'Dorsi Long1: {round(mean_of_min_std_window_f3+self.mvc_offset2,2)}'
            line4 = f'Plantar Long1: {round(mean_of_min_std_window_l3+self.mvc_offset2,2)}'
            line5 = f'Dorsi Long2: {round(mean_of_min_std_window_f2+self.mvc_offset3,2)}'
            line6 = f'Plantar long2: {round(mean_of_min_std_window_l2+self.mvc_offset3,2)}'
            line7 = f'Dorsi improvement Before/Long1: {(round(mean_of_min_std_window_f3+self.mvc_offset2,2)-round(mean_of_min_std_window_f+self.mvc_offset,2))/round(mean_of_min_std_window_f+self.mvc_offset,2)*100}'
            line8 = f'Plantar improvement Before/Long1: {(round(mean_of_min_std_window_l3+self.mvc_offset2,2)-round(mean_of_min_std_window_l+self.mvc_offset,2))/round(mean_of_min_std_window_l+self.mvc_offset,2)*100}'
            line9 = f'Dorsi improvement Before/Long2: {(round(mean_of_min_std_window_f2+self.mvc_offset3,2)-round(mean_of_min_std_window_f+self.mvc_offset,2))/round(mean_of_min_std_window_f+self.mvc_offset,2)*100}'
            line10 = f'Plantar improvement Before/Long2: {(round(mean_of_min_std_window_l2+self.mvc_offset3,2)-round(mean_of_min_std_window_l+self.mvc_offset,2))/round(mean_of_min_std_window_l+self.mvc_offset,2)*100}'
            ...
            ax3.plot(time3,torque3 + self.mvc_offset2 , label = 'Long1')
            ax3.plot(time2,torque2 + self.mvc_offset3 , label = 'Long2')
            ...
            ax5.plot(t2 ,data_voluntary_smoothed2, label='Long2')
            ...
            ax5.plot(t3,data_voluntary_smoothed3, label='Long1')
            ax5.set_ylabel('Position (deg)')
           ...
           # Read the neutral position_tv text file
            ...
            line2 = f"NP long1: {abs(round(float(Neutralposition_tv_post),0))}"
            line3 = f"NP long2: {abs(round(float(Neutralposition_tv_after),0))}"
            line4 = f"DI before/long2: {round(float(dorsiImprovement),0)} %"
            line5 = f"PI before/long2: {round(float(plantarImprovement),0)} %"
            line6 = f"DI before/long1: {round(float(dorsiImprovementpost),0)} %"
            line7 = f"PI before/long1: {round(float(plantarImprovementpost),0)} %"
            ...
            passive_values = {
                 ...
                 'Long-term1': (round(dorsi3 ,2), round(plantar3 ,2)),
                 'Long-term2': (round(dorsi2 ,2), round(plantar2 ,2)),
            }
