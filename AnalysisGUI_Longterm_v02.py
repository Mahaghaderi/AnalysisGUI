...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        button_names = ["TV 5", "TV 50", "TV 100", "TV 120", "MVC", "VOLUNTARY", "ROM", "RMVC_l2", "RMVC_B", "RMVC_l1" ,"ChangeCycle"]
        self.buttons = []
    ...
    def plot_chart(self):
        ...
        if button_index == 0:
           ...
           # Read the neutral position_tv text file
            ...
            self.description_input.append(f'Stiffness Improvement pre/long1: {round(self.stiffness_improvement[0],2)}%')
            self.description_input.append(f'Stiffness Improvement pre/long2: {round(self.stiffness_improvement[1],2)}%')
